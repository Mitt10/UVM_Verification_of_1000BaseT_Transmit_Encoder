...
typedef struct hybridSimInfoT {
    ...
    struct hybridSimReferrerData * I940;
} hybridSimInfoT;
...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I988;
    UB  * I989;
    struct _RmaMultiInputTable * I962;
    struct _RmaMultiInputTable * I991;
} RmaMultiInputTable;
...
typedef struct {
    ...
    US  I1182;
    RP  I1183;
    RemoteDbsedLoad   I1184[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I962;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I962;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I962;
    ...
    U  I1199 :1;
    U  I986 :9;
    RmaSeqPrimOutputOnClkOpt  I1201;
    RmaSeqPrimOutputEblkData  I1205;
...
struct dummyq_struct {
    ...
    struct futq * I1318;
    struct futq * I1319;
    struct sched_table * I1320;
    struct futq_info * I1322;
    struct futq_info * I1324;
    U  I1325;
    U  I1326;
    U  I1327;
    U  I1328;
